      ...
      <div className="selected">
        <div className="choosen_auto">
          ...
          <div className="wrapper-image">
            <div className="choosen_auto_wrapper_img">
              <img alt='' className="choosen_auto_img" src={auto.image} />
            </div>
          </div>
        </div>
        <div className="choosen_service">
          ...
          <div className="wrapper-image">
            <div className="choosen_auto_wrapper_img">
              <img alt='' className="choosen_auto_img" src={service.img} />
            </div>
          </div>
        </div>
        <div className="choosen_master">
          ...
          <div className="wrapper-image">
            <div className="choosen_auto_wrapper_img">
              <img alt='' className="choosen_auto_img" src={master.image} />
            </div>
          </div>
        </div>
